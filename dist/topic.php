  ...
  <div class="container">
    ...
    <div class="col-md-12">
        <div class="deck-header">
          <h1>Emne: <strong>Mærsk Oil</strong></h1> <button class="btn btn-default btn-sm btn-rss">Følg via RSS <i class="fa fa-rss"></i></button>
      </div>
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-8 col-sm-12 module-sm">
        ...
        <? while (dumb_luck("2")): ?>
            ...
            <div class="col-md-6 col-sm-6 module-sm">
...
<div class="spinner">
      ...
      <p class="small">Kilde <a href="http://da.wikipedia.org/wiki/Maersk_Oil" target="_blank">Wikipidia</a></p>
      </section>

      <section class="module-sm">
      <h1 class="section-header">Relaterede emner</h1>
