  ...
  <div class="visible-xs banner module-sm">MOBIL BANNER</div>
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <a href="article.php"><figure class="teaser-img lazy" style="background-image: url(<? dummy("image@420x,1:1") ?>);"></figure></a>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <article class="teaser header-35 teaser-border-top-thick teaser-border-bottom-thick margin-top-0 teaser-overflow teaser-top">
              ...
              <figure class="teaser-img"><a href="article.php"><img class="lazy"  data-original="<? dummy("image@732x,16:9") ?>" width="" height="" alt="" /></a></figure>
              <div class="teaser-body">
      ...
      <div class="col-md-8 col-sm-8">
       ...
       <article class="teaser header-40 teaser-margin-bottom-0 teaser-solid teaser-background-img-tall  module-sm">
            <a href="article.php"><figure class="teaser-img lazy" style="background-image: url(<? dummy("image@620x,1:1") ?>);"></figure></a>
            <div class="teaser-body">
            <footer><a href="section.php" class="cat"><? dummy("text@biz-cat") ?></a> <time><? dummy("text@time-ago-short") ?></time></footer>
            <? dummy("text@biz-headertags") ?>
          ...
          <? if (dumb_luck("50%")): ?>
           <article class="teaser teaser-quote header-20 teaser-border-top-thick">
            ...
            <figure class="teaser-img">
              ...
              <a href="article.php"><img class="lazy"  data-original="<? dummy("image/!author@35x35,") ?>" width="" height="" alt="" /></a>
    ...
    <? while (dumb_luck("4")): ?>
      <li class="col-md-3 col-sm-6 col-xs-6">
        <article class="teaser header-20 ">
            <figure class="teaser-img"><a href="article.php"><img class="lazy"  data-original="<? dummy("image@620x,16:9") ?>" width="" height="" alt="" /></a></figure>
            <div class="teaser-body">
            <footer><a href="section.php" class="cat"><? dummy("text@biz-cat") ?></a> <time><? dummy("text@time-ago-short") ?></time></footer>
            <? dummy("text@biz-headertags") ?>
            <h2 class="header"><a href="article.php"><? dummy("text@headline") ?>
...
<section class="deck">
        ...
        <div class="deck-header">
          ...
          <div class="col-md-8">
            <article class="teaser header-35 header-xs-20 teaser-border-bottom-thick">
              <figure class="teaser-img"><a href="article.php"><img class="lazy"  data-original="<? dummy("image@940x,16:9") ?>" width="" height="" alt="" /></a></figure>
              <footer><a href="section.php" class="cat"><? dummy("text@biz-cat") ?></a> <time><? dummy("text@time-ago-short") ?></time></footer>
      ...
      <div class="col-md-4 col-sm-4 col-xs-12 ">
          <article class="teaser header-20 teaser-border-bottom-thick-xs">
              <figure class="teaser-img"><a href="article.php"><img class="lazy"  data-original="<? dummy("image@394,16:9") ?>" width="" height="" alt="" /></a></figure>
              <footer><a href="section.php" class="cat"><? dummy("text@biz-cat") ?></a> <time><? dummy("text@time-ago-short") ?></time></footer>
              <h2 class="header"><a href="article.php"><? dummy("text@headline") ?>
              <? if (dumb_luck("25%")): ?><? dummy("text@biz-external-href") ?><? endif ?>
              </a></h2>
      ...
      <div class="row">
        ...
        <ul class="list  teaser-round list-light">
          ...
          <figure class="teaser-img"><a href="article.php"><img class="lazy"  data-original="<? dummy("image/!author@50x50,") ?>" width="" height="" alt="" /></a></figure>
          <div class="teaser-body">
   ...
   <div class="row">
      ...
      <div class="col-md-8 ">
        ...
        <article class="teaser header-20 teaser-img-left img-xs-100 teaser-border-bottom">
            <figure class="teaser-img"><a href="article.php"><img class="lazy"  data-original="<? dummy("image@160x,16:9") ?>" width="" height="" alt="" /></a></figure>
              <div class="teaser-body">
              <footer><a href="section.php" class="cat"><? dummy("text@biz-cat") ?></a> <time><? dummy("text@time-ago-short") ?></time></footer>
              <? dummy("text@biz-headertags") ?>
              <h2 class="header"><a href="article.php"><? dummy("text@headline") ?>
 ...
 <div class="row">
      ...
      <div class="col-md-4">
        ...
        <ul class="list  list-light">
          <? while (dumb_luck("5")): ?>
          <li class="teaser teaser-img-left">
          <figure class="teaser-img"><a href="article.php"><img class="lazy"  data-original="<? dummy("image@50x50,") ?>" width="" height="" alt="" /></a></figure>
          <div class="teaser-body">
          <!-- <footer><a href="section.php" class="cat"><? dummy("text@author") ?></a> <time>3d.</time></footer> -->
          <h2 class="header"><a href="article.php"><? dummy("text@headline") ?></a></h2>
          </div>
      ...
      <div class="brandview-info toggle-content">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-xs-6">
            ...
            <figure class="teaser-img"><a href="article-brandview.php"><img class="lazy"  data-original="<? dummy("image@420x,16:9") ?>" width="" height="" alt="" /></a></figure>
  ...
  <section class="deck">    
    <div class="col-md-12 ">
        ...
        <div class=" theme-container theme-dark theme-magazine">
            ...
            <div class="col-md-3">
            <figure class="teaser-img">
              <a href="#"><img class="lazy"  data-original="<? dummy("image/!bizmagasin@x,") ?>" width="" height="" alt="" class="img-responsive" /></a>
            </figure>
            </div>
...
<div class="col-xs-6">
  <article class="teaser teaser-no-logo">
    <figure class="teaser-img"><a href="section.php" class="section-header-link"></a><a href="article-premium.php"><img class="lazy"  data-original="<? dummy("image@420x,16:9") ?>" width="" height="" alt="" /></a></figure>
