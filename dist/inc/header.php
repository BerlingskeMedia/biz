    ...
    <div class="header-bottom col-md-12">
        ...
        <nav class="site-nav">
          <ul class="main-nav desktop-nav">
            ...
            <li ><a href="section.php">TV</a><a href="#" class="show-sub"></a>
            <ul class="sub-menu">
              <li><a href="section.php">Se alle</a></li>
              <? while (dumb_luck("6-9")): ?><li><a href="section.php"><? dummy("text@item") ?></a></li><? endwhile ?>
            </ul>
          ...
          <ul class="main-nav nav-tools">
            ...
            <li class="menu-search hidden-xs"><a href="./"><i class="fa fa-search"></i></a></li>
            <li class="menu-login hidden-xs"><a href="#" data-toggle="modal" data-target="#modal-login"><i class="fa fa-user"></i> <small>Log ind</small></a></li>
          </ul>
