  ...
  <div class="tab-content">
    ...
    <div role="tabpanel" class="tab-pane fade" id="tab-tv-most-viewed">
      ...
      <section class="deck">
        ...
        <div class="col-md-12">
          <h1 class="section-header">Blogs<span class="sub-section-header">fra Berlingske, Politiko og Business</span></h1>
      ...
      <section class="deck">
       ...
       <section class="deck">
        ...
        <div class="col-md-4 col-sm-6 col-xs-6 md-clear-left">
          <article class="teaser header-20 ">
              <figure class="teaser-img"><a href="#"><img src="<? dummy("image@394,16:9") ?>" width="" height="" alt="" /></a></figure>
              <footer><a href="section.php" class="cat"><? dummy("text@biz-cat") ?></a> <time><? dummy("text@time-ago-short") ?></time></footer>
              <h2 class="header"><a href="article.php"><? dummy("text@headline") ?></a></h2>
