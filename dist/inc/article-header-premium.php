<header class="header-sponsor-article header-premium ">
  ...
  <ul>
    ...
    <li><a href="page-text-premium-2.php">FAQ</a>
    <li><a href="page-text-premium-3.php">Kundeservice</a>
    <li><a href="page-text-premium-4.php">Betingelser</a>
    <? if (dumb_luck("50%")): ?><li><a href="#" class="a-pink" data-toggle="modal" data-target="#modal-login">Log ind</a></li><? endif ?>
  </ul>
